class BlockSlab extends BlockBase {
	...
	static createBlocks(slabID: string, doubleSlabID: string, defineData: Block.BlockVariation[], blockType?: string | BlockType) {
		...
		BlockRegistry.registerBlock(doubleSlab);
	}
}
